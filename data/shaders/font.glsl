...
void main()
{
    color.a = texture(images[fragment_input.texture_index], fragment_input.texture_coordinate).r * fragment_input.color.a * fragment_input.vcolor.a;
    if(color.a <= 0.01)
        discard;
    color.rgb = fragment_input.color.rgb * fragment_input.vcolor.rgb;
}