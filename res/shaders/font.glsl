...
void main()
{
    color.a = texture(images[fragment_input.I_image_index], fragment_input.V_texture_coordinate).r * fragment_input.I_color.a * fragment_input.V_color.a;
    if(color.a <= 0.01)
        discard;
    color.rgb = fragment_input.I_color.rgb * fragment_input.V_color.rgb;
}