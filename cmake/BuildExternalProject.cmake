...
macro(externalProject)
    ...
    ExternalProject_Add(${SUBPROJECT_NAME}
        ...
        DOWNLOAD_COMMAND ${CMAKE_COMMAND} -E make_directory ${CMAKE_CURRENT_BINARY_DIR}/${SUBPROJECT_NAME}/src && ${CMAKE_COMMAND} -E copy_directory ${CMAKE_SOURCE_DIR}/ext/${SUBPROJECT_NAME} ${CMAKE_CURRENT_BINARY_DIR}/${SUBPROJECT_NAME}/src
