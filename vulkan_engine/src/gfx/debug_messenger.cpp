...
DebugMessenger::DebugMessenger(VkInstance* instance, VkInstanceCreateInfo* instance_create_info)
    : instance{instance}
{
    create_info = {};
    ...
    instance_create_info->pNext = (VkDebugUtilsMessengerCreateInfoEXT*)&create_info;
}
