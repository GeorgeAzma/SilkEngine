...
execute_process(
  COMMAND "E:/Apps/Git/cmd/git.exe" show-ref "master"
  WORKING_DIRECTORY "E:/Codes/C++/VulkanEngine/vendor/entt"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/Codes/C++/VulkanEngine/vendor/entt'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/Codes/C++/VulkanEngine/vendor/entt'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
