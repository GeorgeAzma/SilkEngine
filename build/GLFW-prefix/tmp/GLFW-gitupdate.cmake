...
execute_process(
  COMMAND "E:/Apps/Git/cmd/git.exe" show-ref "3.3.5"
  WORKING_DIRECTORY "E:/Codes/C++/VulkanEngine/build/GLFW-prefix/src/GLFW"
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "E:/Apps/Git/cmd/git.exe" fetch --tags --force "origin"
    WORKING_DIRECTORY "E:/Codes/C++/VulkanEngine/build/GLFW-prefix/src/GLFW"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "E:/Apps/Git/cmd/git.exe" symbolic-ref -q HEAD
    WORKING_DIRECTORY "E:/Codes/C++/VulkanEngine/build/GLFW-prefix/src/GLFW"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "E:/Apps/Git/cmd/git.exe" for-each-ref "--format='%(upstream:short)'" "${current_branch}"
      WORKING_DIRECTORY "E:/Codes/C++/VulkanEngine/build/GLFW-prefix/src/GLFW"
...
execute_process(
  COMMAND "E:/Apps/Git/cmd/git.exe" status --porcelain
  WORKING_DIRECTORY "E:/Codes/C++/VulkanEngine/build/GLFW-prefix/src/GLFW"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "E:/Apps/Git/cmd/git.exe" stash save --quiet;--include-untracked
    WORKING_DIRECTORY "E:/Codes/C++/VulkanEngine/build/GLFW-prefix/src/GLFW"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "E:/Apps/Git/cmd/git.exe" checkout "${checkout_name}"
    WORKING_DIRECTORY "E:/Codes/C++/VulkanEngine/build/GLFW-prefix/src/GLFW"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "E:/Apps/Git/cmd/git.exe" rebase "${checkout_name}"
    WORKING_DIRECTORY "E:/Codes/C++/VulkanEngine/build/GLFW-prefix/src/GLFW"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "E:/Apps/Git/cmd/git.exe" rebase --abort
      WORKING_DIRECTORY "E:/Codes/C++/VulkanEngine/build/GLFW-prefix/src/GLFW"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "E:/Apps/Git/cmd/git.exe" stash pop --index --quiet
          WORKING_DIRECTORY "E:/Codes/C++/VulkanEngine/build/GLFW-prefix/src/GLFW"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/Codes/C++/VulkanEngine/build/GLFW-prefix/src/GLFW'."
    ...
    execute_process(
      COMMAND "E:/Apps/Git/cmd/git.exe" tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "E:/Apps/Git/cmd/git.exe" reset --hard --quiet
      WORKING_DIRECTORY "E:/Codes/C++/VulkanEngine/build/GLFW-prefix/src/GLFW"
    )
    execute_process(
      COMMAND "E:/Apps/Git/cmd/git.exe" stash pop --quiet
      WORKING_DIRECTORY "E:/Codes/C++/VulkanEngine/build/GLFW-prefix/src/GLFW"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "E:/Apps/Git/cmd/git.exe" reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "E:/Codes/C++/VulkanEngine/build/GLFW-prefix/src/GLFW"
      )
      execute_process(
        COMMAND "E:/Apps/Git/cmd/git.exe" stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/Codes/C++/VulkanEngine/build/GLFW-prefix/src/GLFW'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
