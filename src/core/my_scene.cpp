...
void MyScene::onStart()
{
    ...
    //            0, r, 0, 0,
    //            0, 0, 1, 0,
    //            (i % j) * r * 2 + 30.0f + sin(Time::runtime) * 32.0f, i / j * r * 4 + 30.0f, DebugRenderer::getActive().depth, 1
    //    };
...
void MyScene::onUpdate()
{
    ...
    for (int i = 0; i < 100'000; ++i)
        DebugRenderer::mesh(mesh, (i % j) * r * 2 + 30.0f + sin(Time::runtime * 4.0) * 32.0f, i / j * r * 4 + 30.0f, r, r);
}
